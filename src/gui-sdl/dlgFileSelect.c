...
#define SGFSDLG_READONLY   34

#if WIN32
#define SGFSDLG_DRIVE_LESS	35
#define SGFSDLG_DRIVE_TEXT	36
#define SGFSDLG_DRIVE_MORE	37
...
#if WIN32
#define DLGPATH_SIZE 36 /* make it a little bit shorter on Windows so we have place on drive change */
#else
...
static SGOBJ fsdlg[] =
{
	{ SGBOX, 0, 0, 0,0, TITLE_MAXLEN,26, NULL },
	{ SGTEXT, 0, 0, 25,1, 13,1, NULL },
	{ SGTEXT, 0, 0, 1,3, 6,1, "File:" },
	...
	{ SGTEXT,     0, 0, 46,5, 2,1, sCurrDrive },
	{ SGBUTTON,   0, 0, 49,5, 1,1, "\x03", SG_SHORTCUT_RIGHT },
#endif
