...
const INTERCEPT_ACCESS_FUNC IoMemTable_NEXT[] =
{
	...
	{ 0x02014100, 0x0001e12f, SIZE_BYTE, FLP_StatA_Read, IoMem_WriteWithoutInterceptionButTrace },
	{ 0x02014101, 0x0001e12f, SIZE_BYTE, FLP_StatB_Read, IoMem_WriteWithoutInterceptionButTrace },
	{ 0x02014102, 0x0001e12f, SIZE_BYTE, FLP_DataOut_Read, FLP_DataOut_Write },
	{ 0x02014103, 0x0001e12f, SIZE_BYTE, IoMem_ReadWithoutInterceptionButTrace, IoMem_WriteWithoutInterceptionButTrace },
	...
	{ 0x02014106, 0x0001e12f, SIZE_BYTE, IoMem_ReadWithoutInterceptionButTrace, IoMem_WriteWithoutInterceptionButTrace },
