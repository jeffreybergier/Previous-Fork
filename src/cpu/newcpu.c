...
static void set_x_funcs (void)
{
	...
	dcache_lput = phys_put_long;
	dcache_wput = phys_put_word;
	dcache_bput = phys_put_byte;
	dcache_lget = phys_get_long;
	dcache_wget = phys_get_word;
	dcache_bget = phys_get_byte;
