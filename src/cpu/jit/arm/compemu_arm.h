...
extern uae_u32 jit_fetch_byte(uaecptr addr);
extern uae_u32 jit_fetch_word(uaecptr addr);
extern uae_u32 jit_fetch_long(uaecptr addr);
extern void jit_force_execute_mode(void);
#endif
...
#ifdef WINUAE_FOR_PREVIOUS
#define comp_get_ibyte(o) jit_fetch_byte((uaecptr)(uintptr)(comp_pc_p + (o) + 1))
#define comp_get_iword(o) jit_fetch_word((uaecptr)(uintptr)(comp_pc_p + (o)))
#define comp_get_ilong(o) jit_fetch_long((uaecptr)(uintptr)(comp_pc_p + (o)))
#else
